 ...
 * \note
*/
#ifndef HotSixTex_h__
#define HotSixTex_h__
...
class CTerrainCol;
class CMouseCol;
class CHotSixTex : public ENGINE::CGameObject
{
private:
	float				m_fSpeed;
	float				m_fDistance;
...
public:
	static  CHotSixTex* Create(LPDIRECT3DDEVICE9 pDevice);
	void		Update(void);
	void		Render(void);
...
private:
	explicit CHotSixTex(LPDIRECT3DDEVICE9 pDevice);
public:
	~CHotSixTex();

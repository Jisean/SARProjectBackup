...
HRESULT CSpinCutter::Initialize(void)
{
	...
	m_pPattern1->SetPos(D3DXVECTOR3(4.f, 10.f, 0.f));
	...
	m_pPattern1->SetRotAngle(100.f);


	m_pPattern2 = CPattern1::Create(m_pDevice);
	m_pPattern2->SetPos(D3DXVECTOR3(4.f, 10.f, 0.f));
	...
	m_pPattern2->SetRotAngle(100.f);

	m_pPattern3 = CPattern1::Create(m_pDevice);
	m_pPattern3->SetPos(D3DXVECTOR3(4.f, 10.f, 0.f));
	...
	m_pPattern3->SetRotAngle(100.f);

	m_pPattern4 = CPattern1::Create(m_pDevice);
	m_pPattern4->SetPos(D3DXVECTOR3(4.f, 10.f, 0.f));
	...
	m_pPattern4->SetRotAngle(100.f);

	m_pPattern5 = CPattern1::Create(m_pDevice);
	m_pPattern5->SetPos(D3DXVECTOR3(4.f, 10.f, 0.f));
...
void CSpinCutter::Update(void)
{
	...
	{
		m_pPattern1->Update();
		m_pPattern1->SetPos(D3DXVECTOR3(m_pInfo->m_vPos.x, 5.f, m_pInfo->m_vPos.z + 5.f));
	...
	{
		m_pPattern2->Update();
		m_pPattern2->SetPos(D3DXVECTOR3(m_pInfo->m_vPos.x, 5.f, m_pInfo->m_vPos.z));
	...
	{
		m_pPattern3->Update();
		m_pPattern3->SetPos(D3DXVECTOR3(m_pInfo->m_vPos.x, 5.f, m_pInfo->m_vPos.z - 5.f));
	...
	{
		m_pPattern4->Update();
		m_pPattern4->SetPos(D3DXVECTOR3(m_pInfo->m_vPos.x, 5.f, m_pInfo->m_vPos.z - 10.f));
	...
	{
		m_pPattern5->Update();
		m_pPattern5->SetPos(D3DXVECTOR3(m_pInfo->m_vPos.x, 5.f, m_pInfo->m_vPos.z - 2.5f));
		m_pPattern5->SetScale(D3DXVECTOR3(1.f, 1.f, 5.f + 5.f));
		m_pPattern5->SetTrans(D3DXVECTOR3(0.f, 0.f, 0.f));
	}
	D3DXMATRIX matScale;

...
class CObjectCol;
class CRespawnTex;
class CRespawn : public ENGINE::CGameObject
{
private:
	float				m_fSpeed;
	float				m_fDistance;
...
public:
	...
	static  CRespawn* Create(LPDIRECT3DDEVICE9 pDevice);
	void		Update(void);
	void		Render(void);
	void		SetPos(const D3DXVECTOR3& vPos);
	CRespawnTex* GetMonsterTex(void)
	{
...
private:
	explicit CRespawn(LPDIRECT3DDEVICE9	pDevice);
public:
	~CRespawn();

 ...
 * \note
*/
#ifndef RespawnTex_h__
#define RespawnTex_h__
...
class CTerrainCol;
class CMouseCol;
class CRespawnTex : public ENGINE::CGameObject
{
private:
	float				m_fSpeed;
	float				m_fDistance;
...
public:
	static  CRespawnTex* Create(LPDIRECT3DDEVICE9 pDevice);
	void		Update(void);
	void		Render(void);
...
private:
	explicit CRespawnTex(LPDIRECT3DDEVICE9 pDevice);
public:
	~CRespawnTex();

};
#endif // RespawnTex_h__
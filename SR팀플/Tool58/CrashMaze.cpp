...
HRESULT CCrashMaze::Initialize(void)
{
	...
	m_pPattern2->SetScale(D3DXVECTOR3(1.f, 10.f, 1.f));
	...
	m_pPattern3->SetScale(D3DXVECTOR3(1.f, 10.f, 1.f));
	...
	m_pPattern4->SetScale(D3DXVECTOR3(1.f, 10.f, 1.f));
	...
	m_pPattern5->SetPos(D3DXVECTOR3(50.f, 10.f, 68.f));
...
void CCrashMaze::Update(void)
{
	...
	if(m_pPattern2 != NULL)
	{
		...
		m_pPattern2->SetScale(D3DXVECTOR3(1.f, 10.f, 8.f));
		m_pPattern2->SetTrans(D3DXVECTOR3(2.f, 0.f, 0.f));
	...
	if(m_pPattern3 != NULL)
	{
		...
		m_pPattern3->SetScale(D3DXVECTOR3(1.f, 10.f, 8.f));
		m_pPattern3->SetTrans(D3DXVECTOR3(2.f, 0.f, 0.f));
	...
	if(m_pPattern4 != NULL)
	{
		...
		m_pPattern4->SetScale(D3DXVECTOR3(1.f, 10.f, 8.f));
		m_pPattern4->SetTrans(D3DXVECTOR3(2.f, 0.f, 0.f));

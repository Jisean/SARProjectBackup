...
BOOL CMainFrame::OnCreateClient(LPCREATESTRUCT lpcs, CCreateContext* pContext)
{
	...
	m_MainSplitter.CreateView(0,1, RUNTIME_CLASS(CTool58View), CSize(WINCX, WINCY), pContext);

	m_MainSplitter.CreateView(0, 0, RUNTIME_CLASS(CMyForm), CSize(300, 300), pContext);

	m_MainSplitter.SetColumnInfo(0, 150, 10);

	m_pMainView = (CTool58View*)m_MainSplitter.GetPane(0, 1);
	...
	m_MainSplitter.CreateView(1,1, RUNTIME_CLASS(CTool58View), CSize(300, 300), pContext);*/
	...
	// 2. 가로로 분할할 개수
	// 3. 세로로 분할할 개수
	m_MainSplitter.CreateView(0,0, RUNTIME_CLASS(CMyForm), CSize(300, 600), pContext);
	m_MainSplitter.CreateView(0,1, RUNTIME_CLASS(CTool58View), CSize(WINCX, WINCY), pContext);*/
